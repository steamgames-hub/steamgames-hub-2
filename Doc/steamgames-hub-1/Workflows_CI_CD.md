...
### Auto Release ([CI_auto_release.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_auto_release.yml))
...
### Python Lint ([CI_lint.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_lint.yml))
...
### Pytest ([CI_pytest.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_pytest.yml))
...
### Selenium tests ([CI_selenium.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_selenium.yml))
...
### Codacy Analysis ([CI_codacy_analysis.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_codacy_analysis.yml))
...
### Merge automático de trunk a main ([CI_merge_trunk_to_main](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CI_merge_trunk_to_main.yml))
...
### Deploy to preproduction Render ([CD_render_preproduction.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CD_render_preproduction.yml))
...
### Deploy to Render ([CD_render_production.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CD_render_production.yml))
...
### Publish image in Dockerhub ([render.yml](https://github.com/steamgames-hub/steamgames-hub-1/blob/main/.github/workflows/CD_dockerhub.yml))
...
Si en algún momento es necesario ajustar su comportamiento, añadir nuevas validaciones o modificar los despliegues, cualquier miembro del equipo puede solicitarlo creando una [issue](https://github.com/steamgames-hub/steamgames-hub-1/issues/new?template=feature.md) en el repositorio. Esto permite discutir los cambios, revisarlos de forma conjunta y mantener un sistema coherente y fácil de mantener.
